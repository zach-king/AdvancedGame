...
const short MASK_PLAYER = CATEGORY_ENEMY | CATEGORY_OBSTACLE | CATEGORY_GAME | CATEGORY_ENEMYBULLET;
const short MASK_ENEMY = CATEGORY_PLAYER | CATEGORY_OBSTACLE | CATEGORY_PLAYERBULLET;
